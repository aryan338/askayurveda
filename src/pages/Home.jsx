                ...
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-4xl mx-auto mb-12">
                        ...
                        <p className="text-lg text-gray-600 dark:text-emerald-100/70 leading-relaxed max-w-2xl mx-auto mb-8">
                            Mundada Ayurved Hospital is Nanded's leading center for authentic Ayurveda treatments. Specialized care for Piles, Fistula, Hyper-Acidity, PCOD, PMOS (PCOS), Infertility, Chronic Cervicitis, Arthritis, Spine Disorders, and Sciatica since 1994.
                        </p>
